...
def main():
    # uncomment this to use your own melody
    ...
    # uncomment this to open in musescore
    # score.show()

    # comment this out if musescore gives you trouble and you just want to hear the audio
    # save_score(score)
